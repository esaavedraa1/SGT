    ...
    angular.element(document).ready(function () {
        ...
        nv.addGraph(function() {
            var stackedAreaChartData = [{
                ...
                'color' : red,
                'values' : [ [ 1468683600000 , 13.356778764352],[ 1468783600000 , 9.356778764352],[ 1469083600000 , 7.356778764352],[ 1469183600000 , 9.356778764352]] },
                {
                'key' : 'Ultima Milla',
                'color' : orange,
                'values' : [ [ 1468683600000 , 14.214410956029],[ 1468783600000 , 10.356778764352],[ 1469083600000 , 12.356778764352],[ 1469183600000 , 9.356778764352] ] },
                {
                'key' : 'Troncal',
                'color' : dark,
                'values' : [ [ 1468683600000 , 13.242301508051],[ 1468783600000 , 14.356778764352],[ 1469083600000 , 18.356778764352],[ 1469183600000 , 9.356778764352]] }];
...
colorAdminApp.controller('expressDespachoController', function($scope, $rootScope, $state,$http) {
       ...
       bootbox.alert("El Numero de Solicitud Creado es : 10025 y El Numero de Despacho Creado es el 200120");
});
/* -------------------------------
 100.1 CONTROLLER - Personal Tabla
 ------------------------------- */
