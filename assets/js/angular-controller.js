...
colorAdminApp.controller('tablaMonedaTipoDefaultController', function($scope, $rootScope, $state, $http) {
    ...
    $scope.cargarMonedas_Tipo = function(){
        $http({
            method: 'GET', url: 'http://appsgt.tk:8081/Monedas_Tipo/listar'
        }).
    ...
    $scope.guardarMoneda_Tipo = function() {
        $http({
            method: 'POST',
            url: 'http://appsgt.tk:8081/Monedas_Tipo/guardar',
            params: {
    ...
    $scope.recuperarMoneda_Tipo = function(indice) {
        $http({
            method: 'GET',
            url: 'http://appsgt.tk:8081/Monedas_Tipo/recuperar',
            params: {
                _id: indice
            }
        }).
    ...
    $scope.eliminarMoneda_Tipo = function(indice) {
        $http({
            method: 'POST',
            url: 'http://appsgt.tk:8081/Monedas_Tipo/eliminar',
            params: {
                _id: indice
            }
        }).
