...
colorAdminApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
	...
	//1020X: CONSULTA VIAJE ULTIMA MILLA DESPACHO DIRECTO CLIENTE
        .state('app.consulta.viaje.det_troncal', {
            url: '/det_troncal',
            data: { pageTitle: 'Consulta Viajes Troncales ' },
            templateUrl: 'views/Consulta/Viajes/det_troncal.html',
            resolve: {
                service: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
	...
	//1020X: CONSULTA VIAJE ULTIMA MILLA DESPACHO DIRECTO CLIENTE
        .state('app.consulta.viaje.det_um', {
            url: '/det_um',
            data: { pageTitle: 'Consulta Viajes Ult.Milla ' },
            templateUrl: 'views/Consulta/Viajes/det_um.html',
            resolve: {
                service: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
	...
	//1020X: CONSULTA VIAJE ULTIMA MILLA DESPACHO DIRECTO CLIENTE
        .state('app.consulta.viaje.det_mod', {
            url: '/det_mod',
            data: { pageTitle: 'Consulta Viajes MOD ' },
            templateUrl: 'views/Consulta/Viajes/det_mod.html',
            resolve: {
                service: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
	...
	//1020X: CONSULTA VIAJE ULTIMA MILLA DESPACHO DIRECTO CLIENTE
        .state('app.consulta.viaje.det_ddc', {
            url: '/det_ddc',
            data: { pageTitle: 'Consulta Viajes DDC ' },
            templateUrl: 'views/Consulta/Viajes/det_ddc.html',
            resolve: {
                service: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
	 ...
	 //2010X : APRUEBA RECHAZA ORDEN DE FACTURACION
        .state('app.facturacion.aprobacion.aprueba_sev', {
            url: '/aprueba_sev',
            data: { pageTitle: 'Facturación - Aprobacion OF SEV' },
            templateUrl: 'views/Facturacion/Aprobacion/aprueba_sev.html',
            resolve: {
                service: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
        ...
        //90600
        .state('app.b2b.transportista.of', {
            url: '/of',
            template: '<div ui-view></div>',
            abstract: true
        })
        .state('app.b2b.transportista.of.generar', {
            url: '/generar',
            data: { pageTitle: 'Generar OF' },
            templateUrl: 'views/B2B/Transportista/OF/generar.html',
            resolve: {
                service: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
        ...
        //XXXXX : Pantalla solicitud detalle
	...
	.state('app.b2b.transportista.facturadetalle', {
            url: '/facturadetalle',
            data: { pageTitle: 'Facturas Emitidas' },
            templateUrl: 'views/B2B/Transportista/b2b_factura_detalle_of.html',
            resolve: {
                service: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
	...
	.state('app.b2b.transportista.edita_of', {
            url: '/edita_of',
            data: { pageTitle: 'Edita of' },
            templateUrl: 'views/B2B/Transportista/b2b_factura_edita_of.html',
            resolve: {
                service: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
	...
	.state('app.b2b.transportista.agrega_of', {
            url: '/agrega_of',
            data: { pageTitle: 'Edita of' },
            templateUrl: 'views/B2B/Transportista/b2b_factura_agrega_viaje_of.html',
            resolve: {
                service: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
